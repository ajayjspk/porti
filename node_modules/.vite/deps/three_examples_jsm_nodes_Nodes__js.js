...
var TextureSizeNode_default = TextureSizeNode;
...
var BatchNode = class extends Node_default {
  ...
  setup(builder) {
    ...
    const getIndirectIndex = tslFn(([id2]) => {
      const size2 = textureSize(textureLoad(this.batchMesh._indirectTexture), 0);
      const x2 = int(id2).remainder(int(size2));
      const y2 = int(id2).div(int(size2));
      return textureLoad(this.batchMesh._indirectTexture, ivec2(x2, y2), null, "uvec4").x;
    }).setLayout({
...
var AnalyticLightNode = class extends LightingNode_default {
  ...
  setupShadow(builder) {
    ...
    if (shadowNode === null) {
      ...
      const textureCompare = (depthTexture2, shadowCoord2, compare) => texture(depthTexture2, shadowCoord2).compare(compare);
...
// node_modules/three/examples/jsm/renderers/common/BindGroup.js
var _id = 0;
var BindGroup = class {
...
var NodeBuilder = class {
  ...
  _getBindGroup(groupName, bindings) {
    ...
    if (sharedGroup) {
      ...
      if (bindGroup === void 0) {
        bindGroup = new BindGroup_default(groupName, bindingsArray);
  ...
  getCacheFromNode(node, parent2 = true) {
    ...
    if (data.cache === void 0) data.cache = new NodeCache_default(parent2 ? this.getCache() : null);
    return data.cache;
  }
  isAvailable() {
    return false;
...
var PassNode = class _PassNode extends TempNode_default {
  ...
  getLinearDepthNode() {
    if (this._linearDepthNode === null) {
      const cameraNear2 = this._cameraNear;
      const cameraFar2 = this._cameraFar;
      this._linearDepthNode = viewZToOrthographicDepth(this.getViewZNode(), cameraNear2, cameraFar2);
    }
...
// node_modules/three/examples/jsm/nodes/display/SobelOperatorNode.js
var SobelOperatorNode = class extends TempNode_default {
  ...
  setup() {
    ...
    const uvNode = textureNode.uvNode || uv();
    const sampleTexture = (uv2) => this.textureNode.cache().context({ getUV: () => uv2, forceUVContext: true });
    const sobel2 = tslFn(() => {
...
var sobel = (node) => nodeObject(new SobelOperatorNode(nodeObject(node)));
addNodeElement("sobel", sobel);
var SobelOperatorNode_default = SobelOperatorNode;

// node_modules/three/examples/jsm/nodes/display/DepthOfFieldNode.js
...
var dof = (node, viewZNode, focus, apeture, maxblur) => nodeObject(new DepthOfFieldNode(nodeObject(node), nodeObject(viewZNode), focus, apeture, maxblur));
addNodeElement("dof", dof);
var DepthOfFieldNode_default = DepthOfFieldNode;

// node_modules/three/examples/jsm/nodes/display/DotScreenNode.js
var quadMesh3 = new QuadMesh_default();
var DotScreenNode = class extends TempNode_default {
  ...
  updateBefore(frame) {
    ...
    quadMesh3.material = this._material;
    this.setSize(map.image.width, map.image.height);
    renderer.setRenderTarget(this._renderTarget);
    quadMesh3.render(renderer);
    renderer.setRenderTarget(currentRenderTarget);
...
// node_modules/three/examples/jsm/nodes/display/RGBShiftNode.js
...
var rgbShift = (node, amount, angle) => nodeObject(new RGBShiftNode(nodeObject(node), amount, angle));
...
// node_modules/three/examples/jsm/nodes/lighting/RectAreaLightNode.js
...
// node_modules/three/examples/jsm/nodes/functions/BSDF/LTC.js
...
var PhysicalLightingModel = class extends LightingModel_default {
  ...
  directRectArea({ lightColor, lightPosition, halfWidth, halfHeight, reflectedLight, ltc_1: ltc_12, ltc_2: ltc_22 }) {
    ...
    const t1 = ltc_12.uv(uv2).toVar();
    const t2 = ltc_22.uv(uv2).toVar();
    const mInv = mat3(
      vec3(t1.x, 0, t1.y),
      vec3(0, 1, 0),
      vec3(t1.z, 0, t1.w)
...
export {
  ...
  RGBShiftNode_default as RGBShiftNode,
  RangeNode_default as RangeNode,
  RectAreaLightNode_default as RectAreaLightNode,
  ...
  SobelOperatorNode_default as SobelOperatorNode,
  ...
  TextureSizeNode_default as TextureSizeNode,
